  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-4 md:px-[5vw] py-8 max-w-[1180px] mx-auto w-full">
        <div className="mb-6">
          <h2 className="text-2xl font-extrabold mb-1">Data Kesehatan</h2>
        ...
        {!hasData && (
          <div className="card p-6 mb-5 border-2 border-dashed border-border text-center">
            ...
            <p className="text-sm text-soft max-w-[380px] mx-auto">
              Health data belum tersinkronisasi. Gunakan tombol "Seed 7 Hari Baseline" di bawah untuk demo, atau sambungkan Health Connect di Android.
            </p>
          </div>
        )}
